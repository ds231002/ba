...
Large Language Models (LLMs) werden immer häufiger eingesetzt, um auch komplexe Informationsanfragen zu beantworten @paranjapeARTAutomaticMultistep2023, @yangGPT4ToolsTeachingLarge2023. Durch Integration von externen Werkzeugen können Sprachmodelle beispielsweise auf Datenbanken zugreifen oder Berechnungen durchführen @yangGPT4ToolsTeachingLarge2023, @duanMultitoolIntegrationApplication2024, @alazrakiMetaReasoningImprovesTool2025. Die Entscheidungslogik (Orchestrierung) bestimmt, welche Tools wann und in welcher Reihenfolge aufgerufen werden @huangMetaToolBenchmarkLarge2024, @liuWTUEVALWhetherorNotTool2025.
...
Dabei gibt es eine entscheidende Herausforderung. Die Orchestrierung kann unterschiedlich stark autonomisiert sein. Das bedeutet wie viel Entscheidungsspielraum das LLM bei der Toolauswahl selbst hat und wie viel durch feste Regeln vorgegeben wird. Einfache deterministische Ansätze ermöglichen eine hohe Kontrolle. Autonomere Ansätze können flexibler auf komplexe Anfragen reagieren, sind dagegen schwerer vorhersehbar @zhangGeospatialLargeLanguage2025, @alazrakiMetaReasoningImprovesTool2025, @liuWTUEVALWhetherorNotTool2025, @chenToolUseAlignment2024.
...
// Wie beeinflusst der Grad der Autonomie bei der Tool-Orchestrierung von Large Language Models die Qualität und den Ressourcenbedarf bei der Bearbeitung von Tool-basierten Aufgaben in Energiegemeinschaften?
