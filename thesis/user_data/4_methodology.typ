...
Die Bewertung wird manuell anhand der für die jeweilige Aufgabe erforderlichen Verarbeitungsschritte vorgenommen. Dabei wirde insbesondere geprüft, ob die aufgerufenen Werkzeuge zur Beantwortung der Anfrage erforderlich waren und ob deren Argumente auf den für die Aufgabe notwendigen Umfang beschränkt waren. Da einzelne Aufgaben trotz möglichst eindeutiger Formulierung einen gewissen Interpretationsspielraum aufwiesen, wurde die Bewertung anhand der fachlich erforderlichen Verarbeitung und nicht anhand eines erwarteten Modellverhaltens vorgenommen.
